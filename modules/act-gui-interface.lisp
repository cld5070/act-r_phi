                ...
                (let ((win (make-rpm-window :visible visible 
                  ...
                  (bt:with-lock-held ((window-lock win))
                    ...
                    (let ((name (get-new-command-name "agi-win-move-cursor-monitor")))
                      ...
                      (setf (monitor-move-curosr win) name)
      ...
      (if wind
          ...
          (let (to-remove) 
            ...
            (bt:with-lock-held ((window-lock wind))
              ...
              (when (monitor-move-curosr wind)
                (remove-act-r-command-monitor "move-cursor" (monitor-move-curosr wind))
                (remove-act-r-command (monitor-move-curosr wind)))
