...
(defun update-association-FEAR (FEAR)
 (let ((val 0))
	...
	(when (or (< val (FEAR-max-neg-FEAR-val FEAR)) (= val 0)) (setf val (FEAR-max-neg-FEAR-val FEAR)))
...
(defun update-FEAR (FEAR)
 (let ((val-FEAR (FEAR-val-nociception FEAR))
	...
	(if (<= val-FEAR (FEAR-max-neg-FEAR-val FEAR))
...
;;;;;;;;;;;;;;;;;;;
	;;;;;;;;;;Need to finish this so that the clamp switch is turned off
...
(defun initialize-FEAR ()
 (let ((FEAR (get-module FEAR)))
	(when (FEAR-enabled (get-module FEAR))
		...
		(schedule-periodic-event (FEAR-update-delay-association FEAR) 'update-association-FEAR :priority :max :details "Update association fear value" :params (list FEAR) :module 'FEAR :output nil :maintenance t)
		(schedule-periodic-event (FEAR-update-delay-vision FEAR) 'update-vision-FEAR :priority :max :details "Update vision fear value" :params (list FEAR) :module 'FEAR :output nil :maintenance t)
		(schedule-periodic-event (FEAR-update-delay-audition FEAR) 'update-audition-FEAR :priority :max :details "Update audition fear value" :params (list FEAR) :module 'FEAR :output nil :maintenance t)
		(schedule-periodic-event (FEAR-update-delay-nociception FEAR) 'update-nociception-FEAR :priority :max :details "Update nociception fear value" :params (list FEAR) :module 'FEAR :output nil :maintenance t)
...
(defstruct FEAR
	...
	;ln(max-neg-fear-val)
	(max-neg-FEAR-val 0.001);(eval (/ 1 (exp max-FEAR-val))))
...
(defun FEAR-module-params (FEAR param)
 (if (consp param)
	(case (car param)
	 ...
	 (:FEAR-delay (setf (FEAR-delay FEAR) (cdr param)))
	 (:FEAR-audition-delay (setf (FEAR-update-delay-audition FEAR) (cdr param)))
	 (:FEAR-nociception-delay (setf (FEAR-update-delay-nociception FEAR) (cdr param)))
	 (:FEAR-vision-delay (setf (FEAR-update-delay-vision FEAR) (cdr param)))
	 (:FEAR-association-delay (setf (FEAR-update-delay-association FEAR) (cdr param))))
	(case param
	 ...
	 (:FEAR-delay (FEAR-delay FEAR))
	 (:FEAR-audition-delay (FEAR-update-delay-audition FEAR))
	 (:FEAR-nociception-delay (FEAR-update-delay-nociception FEAR))
	 (:FEAR-vision-delay (FEAR-update-delay-vision FEAR))
	 (:FEAR-association-delay (FEAR-update-delay-association FEAR)))))
