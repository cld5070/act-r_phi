...
proc save_v_graph_history_data {model} {
  ...
  if {$fname != ""} {
    ...
    if {$any == "nil" || $any == ""} {
      ...
      add_cmd $warning_monitor "v_graph_record_warnings" "Environment command for capturing warnings during Save Vertical Graphic trace."
...
proc draw_vert_items {win model fname} {
  ...
  if {$fname == ""} {
    ...
    add_cmd $warning_monitor "v_graph_record_warnings" "Environment command for capturing warnings during Load Vertical Graphic Trace."
