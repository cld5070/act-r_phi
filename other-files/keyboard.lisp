...
(defclass virtual-keyboard ()
   ((key->cmd-ht :accessor key->cmd-ht
    ...
    (left-home :accessor left-home :initform nil)
    (right-home :accessor right-home :initform nil)
    (keypad :accessor keypad :initform nil)))
...
(defmethod initialize-instance :after ((vk virtual-keyboard) &key)
  ...
  (setf (left-home vk) (keyboard-left-home-positions vk))
  (setf (right-home vk) (keyboard-right-home-positions vk))
  (setf (keypad vk) (keyboard-keypad-positions vk))
...
(defgeneric specify-key (keyboard x y names &key default style)
  (:documentation "Specify the names for keys by location, indicate whether it's the default position for that key, and if there's a press-key mapping for it indicate the underlying style and features."))
...
(defgeneric keyboard-left-home-positions (keyboard)
  (:documentation "Specify the hand location and finger offsets."))

(defmethod keyboard-left-home-positions ((k virtual-keyboard))
  (list (list 'hand 4 4) (list 'index 0 0) (list 'middle -1 0) (list 'ring -2 0) (list 'pinkie -3 0) (list 'thumb 1 2)))

(defgeneric keyboard-right-home-positions (keyboard)
  (:documentation "Specify the hand location and finger offsets."))

(defmethod keyboard-right-home-positions ((k virtual-keyboard))
  (list (list 'hand 7 4) (list 'index 0 0) (list 'middle 1 0) (list 'ring 2 0) (list 'pinkie 3 0) (list 'thumb -1 2)))

(defgeneric keyboard-keypad-positions (keyboard)
  (:documentation "Specify the right hand location and finger offsets."))

(defmethod keyboard-keypad-positions ((k virtual-keyboard))
...
(defmethod populate-key-details ((k virtual-keyboard))
  ...
  #|--Begin modified Section for function keys [Dancy]--|#
  ...
  (specify-key k 2 2 "2" :style '(peck-recoil :hand left :finger ring :r 2 :theta -1.57))
  (specify-key k 3 2 "3" :style '(peck-recoil :hand left :finger middle :r 2 :theta -1.57))
  (specify-key k 4 2 "4" :style '(peck-recoil :hand left :finger index :r 2 :theta -1.57))
  (specify-key k 5 2 "5" :style '(peck-recoil :hand left :finger index :r 2.24 :theta -1.11))
  (specify-key k 6 2 "6" :style '(peck-recoil :hand right :finger index :r 2.24 :theta -2.03))
  (specify-key k 7 2 "7" :style '(peck-recoil :hand right :finger index :r 2 :theta -1.57))
  (specify-key k 8 2 "8" :style '(peck-recoil :hand right :finger middle :r 2 :theta -1.57))
  (specify-key k 9 2 "9" :style '(peck-recoil :hand right :finger ring :r 2 :theta -1.57))
  (specify-key k 10 2 "0" :style '(peck-recoil :hand right :finger pinkie :r 2 :theta -1.57))
  ...
  (specify-key k 2 3 "w" :style '(peck-recoil :hand left :finger ring :r 1 :theta -1.57))
  (specify-key k 3 3 "e" :style '(peck-recoil :hand left :finger middle :r 1 :theta -1.57))
  (specify-key k 4 3 "r" :style '(peck-recoil :hand left :finger index :r 1 :theta -1.57))
  (specify-key k 5 3 "t" :style '(peck-recoil :hand left :finger index :r 1.41 :theta -0.79))
  (specify-key k 6 3 "y" :style '(peck-recoil :hand right :finger index :r 1.41 :theta -2.36))
  (specify-key k 7 3 "u" :style '(peck-recoil :hand right :finger index :r 1 :theta -1.57))
  (specify-key k 8 3 "i" :style '(peck-recoil :hand right :finger middle :r 1 :theta -1.57))
  (specify-key k 9 3 "o" :style '(peck-recoil :hand right :finger ring :r 1 :theta -1.57))
  (specify-key k 10 3 "p" :style '(peck-recoil :hand right :finger pinkie :r 1 :theta -1.57))
  ...
  (specify-key k 1 4 "a" :style '(punch :hand left :finger pinkie))
  (specify-key k 2 4 "s" :style '(punch :hand left :finger ring))
  (specify-key k 3 4 "d" :style '(punch :hand left :finger middle))
  (specify-key k 4 4 "f" :style '(punch :hand left :finger index))
  (specify-key k 5 4 "g" :style '(peck-recoil :hand left :finger index :r 1 :theta 0))
  (specify-key k 6 4 "h" :style '(peck-recoil :hand right :finger index :r 1 :theta 3.14))
  (specify-key k 7 4 "j" :style '(punch :hand right :finger index))
  (specify-key k 8 4 "k" :style '(punch :hand right :finger middle))
  (specify-key k 9 4 "l" :style '(punch :hand right :finger ring))
  (specify-key k 10 4 '(";" "semicolon") :style '(punch :hand right :finger pinkie))
  ...
  (specify-key k 2 5 "x" :style '(peck-recoil :hand left :finger ring :r 1 :theta 1.57))
  (specify-key k 3 5 "c" :style '(peck-recoil :hand left :finger middle :r 1 :theta 1.57))
  (specify-key k 4 5 "v" :style '(peck-recoil :hand left :finger index :r 1 :theta 1.57))
  (specify-key k 5 5 "b" :style '(peck-recoil :hand left :finger index :r 1.41 :theta 0.79))
  (specify-key k 6 5 "n" :style '(peck-recoil :hand right :finger index :r 1.41 :theta 2.36))
  (specify-key k 7 5 "m" :style '(peck-recoil :hand right :finger index :r 1 :theta 1.57))
  (specify-key k 8 5 '("," "comma") :style '(peck-recoil :hand right :finger middle :r 1 :theta 1.57))
  (specify-key k 9 5 '("." "period" "dot") :style '(peck-recoil :hand right :finger ring :r 1 :theta 1.57))
  (specify-key k 10 5 '("/" "slash") :style '(peck-recoil :hand right :finger pinkie :r 1 :theta 1.57))
  (specify-key k 11 5 "right-shift" :style '(peck-recoil :hand right :finger pinkie :r 1.41 :theta 0.78))
  ...
  (specify-key k 2 6 '("command" "left-command") :style '(peck-recoil :hand left :finger ring :r 2.0 :theta 1.57))
  (specify-key k 3 6 "space" :default nil)
  (specify-key k 4 6 "space" :default nil)
  (specify-key k 5 6 "space" :style '(punch :hand left :finger thumb))
  ...
  (specify-key k 11 6 "right-command" :style '(peck-recoil :hand right :finger pinkie :r 2.24 :theta 1.11))
  (specify-key k 12 6 "right-option" :style '(peck-recoil :hand right :finger pinkie :r 2.83 :theta 0.78))
  (specify-key k 13 6 "right-control" :style '(peck-recoil :hand right :finger pinkie :r 3.6 :theta 0.59))
...
(defmethod specify-key ((k virtual-keyboard) x y names &key (default t) style)
  (unless (listp names)
               ...
               (if (null (first command))
                 ...
                 (let* ((hand-index (position :hand command))
                        ...
                        (hand (case hand-name
                                ...
                                (t (print-warning "Invalid hand ~s in press-key command ~s for key ~s." hand-name command key)
                                   (return-from press-key))))
                        (device (bt:with-lock-held ((hand-lock hand))
                                  (device hand))))
        ...
        (if k
            (if (or (eq hand 'right) (eq hand 'left))
                (let* ((cur-hand (if (eq hand 'left)
                  ...
                  (bt:with-lock-held ((hand-lock cur-hand))
                    ;(setf (device cur-hand) it)
                    (unless (equal home-pos (loc cur-hand))
                      (let ((polar (xy-to-polar (loc cur-hand) home-pos)))
                        (point-hand mtr-mod :hand hand :r (vr polar) :theta (vtheta polar) :twidth 4.0 :device it
                                    :offsets (remove (find 'hand keyboard-hand :key 'first) keyboard-hand) :request-spec request-spec)))))
...
(defmethod hand-to-keypad ((mtr-mod motor-module) request)
  (aif (find "keyboard" (current-devices "motor") :key 'second :test 'string-equal)
      (let ((k (current-keyboard)))
        (if k
            (let ((keypad-pos (coerce (rest (find 'hand (keypad k) :key 'first)) 'vector))
                  (rh (right-hand mtr-mod)))
              (bt:with-lock-held ((hand-lock rh))
                ;(setf (device rh) it)
                (unless (equal keypad-pos (loc rh))
                  (let ((polar (xy-to-polar (loc rh) keypad-pos)))
                    (point-hand mtr-mod :hand 'right :r (vr polar) :theta (vtheta polar) :twidth 4.0 :device it
                                :offsets (remove (find 'hand (keypad k) :key 'first) (keypad k)) :request-spec request)))))
         ...
         (let ((new-loc (key->loc (current-keyboard) to-key)))
           (if new-loc
               (let* ((cur-hand (ecase hand
                 ...
                 (point-hand mtr-mod :hand hand :r (vr new-polar) :theta (vtheta new-polar) :offsets offsets :request-spec request-spec :device it))
...
(defmethod home-hands ((k virtual-keyboard) &optional force-hand-to-device)
  (let ((device (find "keyboard" (current-devices "motor") :test 'string-equal :key 'second)))
    (when (or force-hand-to-device (null (notify-interface "motor" '(get-hand-device right))))
      (let* ((r-pos (find 'hand (right-home k) :key 'first))
             (r-fingers (remove r-pos (right-home k))))
...
(define-component keyboard-table :version "2.2" :documentation "Record the keyboards used for each model."
